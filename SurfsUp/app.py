...
def welcome():
    ...
    return(
        ...
        f" <img width='600' src='https://wallpapercave.com/wp/wp5555822.jpg'/ >"
        ...
        f"JSON list of the temperature observations of the most-active station for the previous year of data.</a></li><br/><br/>"
